...
is very different for protons and neutrons. As the $F_1$ form factor of the 
neutron is very small, the $E$ GPD is more prominent in some of the neutron DVCS 
observables. Most notably the $\sin$ component of the beam spin asymmetry is given 
...
\end{equation}
highlighting the effect of a suppressed $F_1$ on the main terms.
